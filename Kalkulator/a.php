  ...
  <form name="kalkulator" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" onSubmit="return valid()" >
  <div class="content">
  ...
  <div class="min_content">
  <label>
    <input type="text" name="input1" id="input1" value= "<?php echo $_POST['input1'];?>" onkeypress="return nomer(event)"/>
  </label>
  <select name="operasi">
    <option value="+" <?php
  if ($_POST['operasi'] == "+") {
